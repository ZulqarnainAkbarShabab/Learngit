#!/usr/bin/python
# coding: utf-8
# This module takes the filepath as input and returns the transformed file in the same lov
...
class LocalOCR(object):
    ...
    def process(self, pdf_filename, pdf_resolution, imageformat, do_orientation, png_filename): #Attribute png File name is added by me
		...
		#print("Update Wand library: {}".format(e))
            img_per_page.save(filename=png_filename)# i have changed this to png_filename from 'buffer.png'
            page_start = time.time()
            self.image2txt_pyocr(img_per_page.make_blob(imageformat), do_orientation)
...
if __name__ == '__main__':
    ...
    parser.add_argument('png_filename',nargs='?', default='buffer.png',
